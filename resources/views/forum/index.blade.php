        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-6 col-12">
                    <div class="post-container">
                        ...
                        @if ($question->isEmpty())
                            <div class="post">
                                <div class="post-left">
                                    <p>Diễn đàn {{ $newid }} chưa có câu hỏi nào</a></p>
                                    <small class="text-muted">Hãy là người đầu tiên đặt câu hỏi</small>
                                </div>
                        ...
                        @else
                            @foreach ($question as $ques)
                                <div class="post">
                                    <div class="post-left">
                                        <p><a href="/forum/{{$title}}/{{ $ques->id }}">{{ $ques->title }}</a></p>
                                        <small class="text-muted">Vào lúc: <span
                                                class="timestamp">{{ $ques->timestamp }}</span></small>
                                    </div>
                                    <div class="post-right">
                                        <p>Reps: <span class="comments">{{ $ques->reps }}</span></p>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="post-container">
                        <h2>Bài đăng thu hút</h2>
                        @if ($popularquestion->isEmpty())
                            <div class="post">
                                <div class="post-left">
                                    <p>Diễn đàn {{ $newid }} chưa có câu hỏi nào</a></p>
                                    <small class="text-muted">Hãy là người đầu tiên đặt câu hỏi</small>
                        ...
                        @else
                            ...
                            @for ($i = 0; $i < $n; $i++)
                                <div class="post">
                                    <div class="post-left">
                                        <p><a href="/forum/{{$title}}/{{ $popularquestion[$i]->id }}">{{ $popularquestion[$i]->title }}</a></p>
                                        <small class="text-muted">Vào lúc: <span
